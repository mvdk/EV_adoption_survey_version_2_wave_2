class Lexicon:
    ...
    product_intro_text4 =  "Nun bitten wir Sie, solchen Angebote erneut zu bewerten – allerdings unter einem veränderten Szenario."
    product_intro_text5 = "Bitte klicken Sie auf „Weiter“, um fortzufahren."
